...
v=["val","css","html","text","data","width","height","offset"],y=p.createElement("table"),g=p.createElement("tr"),E={tr:p.createElement("tbody"),tbody:y,thead:y,tfoot:y,td:g,th:g,"*":p.createElement("div")},w=/complete|loaded|interactive/,b=/^[\w-]*$/,S={},x=S.toString,N={},O=p.createElement("div"),P=Array.isArray||function(e){return e instanceof Array};function C(e){return null==e?String(e):S[x.call(e)]||"object"}function j(e){return"function"===C(e)}function T(e){return null!=e&&e==e.window}function A(e){return"object"===C(e)}function D(e){return A(e)&&!T(e)&&Object.getPrototypeOf(e)==Object.prototype}
// true if type data is array
function k(e){var t=!!e&&"length"in e&&e.length,n=s.type(e);return"function"!=n&&!T(e)&&("array"==n||0===t||"number"==typeof t&&0<t&&t-1 in e)}function L(e){return e.replace(/::/g,"/").replace(/([A-Z]+)([A-Z][a-z])/g,"$1_$2").replace(/([a-z\d])([A-Z])/g,"$1_$2").replace(/_/g,"-").toLowerCase()}function _(e){return e in t?t[e]:t[e]=new RegExp("(^|\\s)"+e+"(\\s|$)")}function V(e,t){return"number"!=typeof t||n[L(e)]?t:t+"px"}function q(e,t){var n,r;if(k(e)){for(n=0;n<e.length;n++)if(!1===t.call(e[n],n,e[n]))return e}else for(r in e)if(!1===t.call(e[r],r,e[r]))return e;return e}function M(e,t){var n,r=e?e.length:0;for(n=0;n<r;n++)this[n]=e[n];this.length=r,this.selector=t||""}
// `$SO.sociolla.fragment` takes a html string and an optional tag name
// to generate DOM nodes from the given html string.
// The generated DOM nodes are returned as an array.
// This function can be overridden in plugins for example to make
// it compatible with browsers that don't support the DOM fully.
function z(e,t,n,r){return j(t)?t.call(e,n,r):t}
// access className property while respecting SVGAnimatedString
function B(e,t){var n=e.className||"",r=n&&n.baseVal!==c;if(t===c)return r?n.baseVal:n;r?n.baseVal=t:e.className=t}
// "true"  => true
// "false" => false
// "null"  => null
// "42"    => 42
...
var r,i=e.parentNode,o=!i;return o&&(i=O).appendChild(e),r=~N.qsa(i,t).indexOf(e),o&&O.removeChild(e),r},a=function(e){return e.replace(/-+(.)?/g,function(e,t){return t?t.toUpperCase():""})},e=function(n){return f.call(n,function(e,t){return n.indexOf(e)==t})},N.fragment=function(e,t,n){var r,i,o;
...
,N.S=function(e,t){return new M(e,t)}
...
if(P(e))r=e,n=f.call(r,function(e){return null!=e});
// Wrap DOM nodes.
...
(s=function(e,t){return N.init(e,t)}).extend=function(t){var n,e=l.call(arguments,1);return"boolean"==typeof t&&(n=t,t=e.shift()),e.forEach(function(e){!function e(t,n,r){for(u in n)r&&(D(n[u])||P(n[u]))?(D(n[u])&&!D(t[u])&&(t[u]={}),P(n[u])&&!P(t[u])&&(t[u]=[]),e(t[u],n[u],r)):n[u]!==c&&(t[u]=n[u])}(t,e,n)}),t}
...
N.uniq=e,N.deserializeValue=function(t){try{return t?"true"==t||"false"!=t&&("null"==t?null:+t+""==t?+t:/^[\[\{]/.test(t)?$.parseJSON(t):t):t}catch(e){return t}},s.sociolla=N,s}();window.Sociolla=e,void 0===window.$SO&&(window.$SO=e),function(f){var l,t=1,s=Array.prototype.slice,p=f.isFunction,h=function(e){return"string"===f.type(e)},d={},o={},n="onfocusin"in window,r={focus:"focusin",blur:"focusout"},m={mouseenter:"mouseover",mouseleave:"mouseout"};function v(e){return e._sid||(e._sid=t++)}function u(e,t,n,r){if((t=y(t)).ns)var i=(o=t.ns,new RegExp("(?:^| )"+o.replace(" ",".* ?")+"(?: |$)"));var o;return(d[v(e)]||[]).filter(function(e){return e&&(!t.e||e.e==t.e)&&(!t.ns||i.test(e.ns))&&(!n||v(e.fn)===v(n))&&(!r||e.sel==r)})}function y(e){var t=(""+e).split(".");return{e:t[0],ns:t.slice(1).sort().join(" ")}}function g(e,t){return e.del&&!n&&e.e in r||!!t}function E(e){return m[e]||n&&r[e]||e}function w(i,e,t,o,u,a,c){var n=v(i),s=d[n]||(d[n]=[]);e.split(/\s/).forEach(function(e){if("ready"==e)return f(document).ready(t);var n=y(e);n.fn=t,n.sel=u,
// emulate mouseenter, mouseleave
n.e in m&&(t=function(e){var t=e.relatedTarget;if(!t||t!==this&&!f.contains(this,t))return n.fn.apply(this,arguments)});var r=(n.del=a)||t;n.proxy=function(e){if(!(e=x(e)).isImmediatePropagationStopped()){e.data=o;var t=r.apply(i,e._args==l?[e]:[e].concat(e._args));return!1===t&&(e.preventDefault(),e.stopPropagation()),t}},n.i=s.length,s.push(n),"addEventListener"in i&&i.addEventListener(E(n.e),n.proxy,g(n,c))})}function b(t,e,n,r,i){var o=v(t);(e||"").split(/\s/).forEach(function(e){u(t,e,n,r).forEach(function(e){delete d[o][e.i],"removeEventListener"in t&&t.removeEventListener(E(e.e),e.proxy,g(e,i))})})}o.click=o.mousedown=o.mouseup=o.mousemove="MouseEvents",f.event={add:w,remove:b},f.proxy=function(e,t){var n=2 in arguments&&s.call(arguments,2);if(p(e)){var r=function(){return e.apply(t,n?n.concat(s.call(arguments)):arguments)};return r._sid=v(e),r}if(h(t))return n?(n.unshift(e[t],e),f.proxy.apply(null,n)):f.proxy(e[t],e);throw new TypeError("expected function")};var a=function(){return!0},S=function(){return!1},i=/^([A-Z]|returnValue$|layer[XY]$|webkitMovement[XY]$)/,e={preventDefault:"isDefaultPrevented",stopImmediatePropagation:"isImmediatePropagationStopped",stopPropagation:"isPropagationStopped"};function x(r,i){return!i&&r.isDefaultPrevented||(i||(i=r),f.each(e,function(e,t){var n=i[e];r[e]=function(){return this[t]=a,n&&n.apply(i,arguments)},r[t]=S}),r.timeStamp||(r.timeStamp=Date.now()),(i.defaultPrevented!==l?i.defaultPrevented:"returnValue"in i?!1===i.returnValue:i.getPreventDefault&&i.getPreventDefault())&&(r.isDefaultPrevented=a)),r}function N(e){var t,n={originalEvent:e};for(t in e)i.test(t)||e[t]===l||(n[t]=e[t]);return x(n,e)}f.fn.on=function(t,i,n,o,u){var a,c,r=this;return t&&!h(t)?(f.each(t,function(e,t){r.on(e,i,n,t,u)}),r):(h(i)||p(o)||!1===o||(o=n,n=i,i=l),o!==l&&!1!==n||(o=n,n=l),!1===o&&(o=S),r.each(function(e,r){u&&(a=function(e){return b(r,e.type,o),o.apply(this,arguments)}),i&&(c=function(e){var t,n=f(e.target).closest(i,r).get(0);if(n&&n!==r)return t=f.extend(N(e),{currentTarget:n,liveFired:r}),(a||o).apply(n,[t].concat(s.call(arguments,1)))}),w(r,t,o,n,i,c||a)}))},f.fn.off=function(e,n,t){var r=this;return e&&!h(e)?(f.each(e,function(e,t){r.off(e,n,t)}),r):(h(n)||p(t)||!1===t||(t=n,n=l),!1===t&&(t=S),r.each(function(){b(this,e,t,n)}))},f.fn.trigger=function(e,t){return(e=h(e)||f.isPlainObject(e)?f.Event(e):x(e))._args=t,this.each(function(){
